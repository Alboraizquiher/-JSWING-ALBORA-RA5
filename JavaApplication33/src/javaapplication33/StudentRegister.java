...
public class StudentRegister {
     ...
     * @param introData
     *
     * Add a new student to the registry. o Ask the user to enter the student's
     * data (name, surname, age, courses, and ID). Create an object of the
     * "Student" class with the entered data and save the information in the
    ...
    /**
     *  Display the list of registered students. o Read the content of the
     * "registration.txt" file and display the data of each stored student on
     * the screen.
     */
    ...
    /**
     * Delete a student from the registry. o The list of students will be
     * displayed and the user will be asked to indicate the ID of the student
     * they want to delete.
     */
    ...
    /**
     * Buscar un alumno por su DNI. o Solicitar al usuario que ingrese el DNI
     * del alumno a buscar. Leer el archivo "registro.txt" y mostrar en pantalla
     * los datos del alumno que coincidan con el DNI ingresado.
     */
    public void searchStudent() {
        ...
        for (int i = 0; i < students.size(); i++) {
            ...
            if (students.get(i).getDni().equals(DniSearch)) {
                ...
                Estudiante += (students.get(i).getName() + " ; " + students.get(i).getLastName() + " ; "
                        + students.get(i).getCourse() + " ; " + students.get(i).getDni());
